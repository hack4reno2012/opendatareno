...
<div class="regpopup" style = "padding: 20px;">
...
<p>Open Data Reno requires you to <a href="<?php echo get_option('siteurl').'/wp-login.php'; ?>" title="Log in"> login</a> in order to vote.</p>
<p>If you do not have an account yet you can <a href="<?php echo get_option('siteurl').'/wp-login.php?action=register'; ?>" title="Register account">create one here</a>.</p></div></div>
<?php
}
}
