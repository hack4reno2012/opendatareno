...
class GFCommon{
    ...
    public static $version = "1.3.13.1";
    ...
    public static function get_checkbox_choices($field, $value, $disabled_text){
        ...
        return apply_filters("gform_field_choices", $choices, $field);
    ...
    public static function get_field_input($field, $value="", $lead_id=0, $form_id=0){
        ...
        switch(RGFormsModel::get_input_type($field)){
            ...
            case "email":
                ...
                return sprintf("<div class='ginput_container'><input name='input_%d' id='%s' type='%s' value='%s' class='%s' tabindex='%d' $html5_attributes %s/></div>", $id, $field_id, $html_input_type, esc_attr($value), esc_attr($class), self::$tab_index++, $disabled_text);
            break;
            ...
            case "number" :
                ...
                return sprintf("<div class='ginput_container'><input name='input_%d' id='%s' type='{$html_input_type}' value='%s' class='%s' tabindex='%d' %s/>%s</div>", $id, $field_id, esc_attr($value), esc_attr($class), self::$tab_index++, $disabled_text, $instruction);
            ...
            case "phone" :
                ...
                return sprintf("<div class='ginput_container'><input name='input_%d' id='%s' type='{$html_input_type}' value='%s' class='%s' tabindex='%d' %s/>$instruction_div</div>", $id, $field_id, esc_attr($value), esc_attr($class), self::$tab_index++, $disabled_text);
            ...
            case "time" :
                ...
                return sprintf("<div class='clear-multi'><div class='gfield_time_hour ginput_container' id='%s'><input type='text' maxlength='2' name='input_%d[]' id='%s.1' value='%s' tabindex='%d' %s/> : <label for='%s.1'>" . __("HH", "gravityforms") . "</label></div><div class='gfield_time_minute'><input type='text' maxlength='2' name='input_%d[]' id='%s.2' value='%s' tabindex='%d' %s/><label for='%s.2'>" . __("MM", "gravityforms") . "</label></div><div class='gfield_time_ampm'><select name='input_%d[]' id='%s.3' tabindex='%d' %s><option value='am' %s>" . __("AM", "gravityforms") . "</option><option value='pm' %s>" . __("PM", "gravityforms") . "</option></select></div></div>", $field_id, $id, $field_id, $hour, self::$tab_index++, $disabled_text, $field_id, $id, $field_id, $minute, self::$tab_index++, $disabled_text, $field_id, $id, $field_id, self::$tab_index++, $disabled_text, $am_selected, $pm_selected);
